    ...
    foreach ($result as $row) {
        ...
        <tr class="block__table-body-row">
            ...
            <td class="block__table-body-text">
                <?php
                if ($row['status'] == 1) {
                    echo "<div class='block__circle block__circle--green' data-target='status'><input type='hidden' name='status' value='1'></div>";
                } else if ($row['status'] == 0) {
                    echo "<div class='block__circle block__circle--gray' data-target='status'><input type='hidden' name='status' value='0'></div>";
                }
                ?>
            </td>
            <td class="block__table-body-text">
